...
export default {
  ...
  data() {
    return {
      ...
      // url: "http://localhost:85/icp2022/icp_v1_suser/self_assessment_report/api-member.php",
      ...
      url: "https://icp2022.net/icp_v1_suser/self_assessment_report/api-member.php",
      url_api_career_qualification:
